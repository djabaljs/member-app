 ...
 */
final class Version20210925021421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE member_id members_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE post ADD CONSTRAINT FK_5A8A6C8DBD01F5ED FOREIGN KEY (members_id) REFERENCES member (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE members_id member_id INT DEFAULT NULL');
